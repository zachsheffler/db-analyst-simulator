...
export default function App() {
  ...
  useEffect(() => {
    ...
    return () => window.removeEventListener('dbsim-progress', h)
  }, [])
        ...
        <div className="app">
          ...
          <div className="workspace">
            ...
            <section className="pane controls-pane">
              <div className="pane-title">Timer &amp; controls</div>
              <SlotOutlet name="controls" className="pane-body" fallback={<div className="muted">Pick a job to start the clock.</div>} />
            </section>
